...
class Scraper:
    ...
    def scrape_page_info(url, driver):
        driver.get(url)
        # time.sleep(10)
        # if driver.current_url.startswith('https://www.epicgames.com/id/login'):
        #     driver.back()
        time.sleep(2)
        try:
...
if __name__ == "__main__":
    ...
    # print('Logging In')
    # epicgames.driver.get('https://www.epicgames.com/id/login/epic')
    # time.sleep(5)
    # username = epicgames.driver.find_element_by_id(
    #     'email')
    # password = epicgames.driver.find_element_by_id(
    #     'password')
    # sign_in = epicgames.driver.find_element_by_id(
    #     'sign-in')
    # username.send_keys('')
    # password.send_keys('')
    # sign_in.click()
