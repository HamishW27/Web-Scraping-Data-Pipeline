...
class TestLinks(unittest.TestCase):
    ...
    def test_get_links(self):
        ...
        expected_item = 'https://store.epicgames.com/en-US/p/grand-theft-auto-v'
        actual_items = epicgames.get_links()
        self.assertIn(expected_item, actual_items)

    def test_scrape_page_info(self):
        id_links = [{'url': 'https://store.epicgames.com/en-US/p/grand-theft-auto-v',
                     'id': '7c886093-e7e4-4e22-86c7-182183fdb925'}]
    ...
    def test_parse_percentage(self):
        self.assertEqual(parse_percentage('90%'), 90,
                         'Should be an integer 90')
